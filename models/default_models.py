...
models_dict = {
    'Classification': {
        ...
        'CatBoost': CatBoostClassifier(iterations=1000, learning_rate=0.03, depth=6, verbose=False),
        'XGBoost': XGBClassifier(n_estimators=100, max_depth=3, learning_rate=0.1, use_label_encoder=False, eval_metric='logloss'),
        'LightGBM': LGBMClassifier(num_leaves=31, learning_rate=0.1, n_estimators=100),
    },
    'Regression': {
        ...
        'CatBoost': CatBoostRegressor(iterations=1000, learning_rate=0.03, depth=6, verbose=False),
